...
from .endpoints.policy_rate import PolicyRateEndpoint
...
class BOTClient:
    ...
    - `interest_key` (env `BOT_CLIENT_ID_INTEREST`) -> `interest`,
      ...
      `spot_rate`, `swap_point`, `interbank_txn_rate`, `bibor`,
      `policy_rate` (all under BOT's "Interest Rates" subscription plan
      alongside LoanRate)
    ...
    def __init__(
        ...
        self.policy_rate = PolicyRateEndpoint(self)
